...
Important:
    A correctly named pattern automatically supports direct downloads when opened
    through its customer link:

        ?pattern=PATTERN-ID&direct=1

    The normal public catalogue remains preview-only. Only upload original pattern
    assets that you intend to make available through customer-specific links.
"""
...
PALETTES = [
    # Cream & Linen
    {"category": "Cream & Linen", "name": "Oat Milk & Walnut", "bg": "#F1E8D8", "line": "#665044"},
    {"category": "Cream & Linen", "name": "Porcelain Cocoa", "bg": "#FAF6EC", "line": "#5B493D"},
    {"category": "Cream & Linen", "name": "Almond Linen", "bg": "#E9DECB", "line": "#725E50"},
    {"category": "Cream & Linen", "name": "Biscuit Cream", "bg": "#F5EAD8", "line": "#795D49"},
    {"category": "Cream & Linen", "name": "Vanilla Hazelnut", "bg": "#F8EFDD", "line": "#6D5544"},
    {"category": "Cream & Linen", "name": "Cashmere Cream", "bg": "#EEE6DA", "line": "#5E5550"},
    {"category": "Cream & Linen", "name": "Buttercream Umber", "bg": "#FFF5DE", "line": "#745542"},
    {"category": "Cream & Linen", "name": "Ivory Ink", "bg": "#FBF8F0", "line": "#484441"},

    # Muted Scandi
    {"category": "Muted Scandi", "name": "Nordic Fog", "bg": "#E8ECE7", "line": "#4F5F59"},
    {"category": "Muted Scandi", "name": "Dusty Fjord", "bg": "#DDE6E8", "line": "#536873"},
    {"category": "Muted Scandi", "name": "Clay Cabin", "bg": "#E9D8CE", "line": "#805C50"},
    {"category": "Muted Scandi", "name": "Moss Linen", "bg": "#E3E4D7", "line": "#596453"},
    {"category": "Muted Scandi", "name": "Oat Navy", "bg": "#EDE4D3", "line": "#384A5A"},
    {"category": "Muted Scandi", "name": "Faded Berry", "bg": "#EEE2E3", "line": "#6D5058"},
    {"category": "Muted Scandi", "name": "Quiet Mustard", "bg": "#F2E7C7", "line": "#6E6144"},
    {"category": "Muted Scandi", "name": "Pale Birch", "bg": "#F6F2E9", "line": "#555B5C"},
    ...
    # Modern Colour Edit
    {"category": "Modern Colour Edit", "name": "Cloud Dancer", "bg": "#FAF9F6", "line": "#3F4745"},
    {"category": "Modern Colour Edit", "name": "Soft Jade", "bg": "#F2F4EE", "line": "#68745F"},
    {"category": "Modern Colour Edit", "name": "Cool Blue Ink", "bg": "#EFF8FC", "line": "#547185"},
    {"category": "Modern Colour Edit", "name": "Plum Noir", "bg": "#F8F3F5", "line": "#351E28"},
    {"category": "Modern Colour Edit", "name": "Persimmon Milk", "bg": "#FFF3EE", "line": "#A94F39"},
...
def palette_categories() -> list[str]:
    """Return the palette collections in their intentional display order."""
    return list(dict.fromkeys(palette["category"] for palette in PALETTES))
...
def direct_download_requested() -> bool:
    """Enable files only for explicit pattern-specific customer links."""
    value = str(st.query_params.get("direct", "")).strip().casefold()
...
def palette_controls(pattern: Pattern) -> tuple[str, str, str]:
    ...
    category_options = ["Popular", *palette_categories()]
    collection_label = (
...
def render_app() -> None:
    ...
    # Every correctly named pattern supports direct downloads automatically, but
    # only when the customer opens its explicit ?pattern=ID&direct=1 link. The
    # ordinary catalogue stays preview-only.
    is_direct_download = (
        bool(requested_id)
        and selected_pattern.pattern_id == requested_id
        and direct_download_requested()
    )

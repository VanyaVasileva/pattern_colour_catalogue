...
def single_tile_preview(tile: Image.Image, canvas_size: tuple[int, int] = PREVIEW_SIZE) -> Image.Image:
    """Show one complete, sharp pattern tile and add a light watermark."""
...
def render_app() -> None:
    ...
    preview = single_tile_preview(tile)

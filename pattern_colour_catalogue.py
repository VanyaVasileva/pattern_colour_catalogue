...
GitHub / Streamlit Community Cloud:
    ...
    2. Add a requirements.txt containing:
           streamlit>=1.42
           Pillow>=10.0
    3. Add LOW-RESOLUTION preview tiles using this folder structure:

       patterns/
         both/
           Animals/
             HIP014__Curious_Hippos.png
         background/
           Botanicals/
             BOT003__Acorn_Branches.png
         line/
           Animals/
             FOX008__Little_Foxes.png
...
def render_app() -> None:
    ...
    st.title(APP_TITLE)
    st.write("Choose a pattern, try a curated palette or enter your own colours, then take a screenshot.")
    ...
    st.subheader("3. Preview and screenshot")
    ...
    st.info("Alternatively, take one screenshot showing the preview and colour details.")
